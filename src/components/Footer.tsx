    ...
    <footer className='bg-fourth-500 text-neutral-50'>
        <div className='max-w-7xl px-10 py-6 mx-auto gap-16 grid grid-cols-4'>
            ...
            <div className='flex flex-col'>
                ...
                <p className='hover:text-fourth-200 py-1'><Link to={'/services'}>{t('footer.services')}</Link></p>
            </div>

            <div className='flex flex-col'>
                <p className='py-1 text-2xl text-tertiary-400 font-bold text-footer-widgets'> {t('footer.services')} </p>
                <p className='hover:text-fourth-200 py-1'> <Link to={'/services'}> {t('footer.regulatory-affairs')}</Link></p>
                <p className='hover:text-fourth-200 py-1'> <Link to={'/services'}> {t('footer.sanitary-legislation')}</Link></p>
                <p className='hover:text-fourth-200 py-1'> <Link to={'/services'}> {t('footer.auditories')} </Link></p>
                <p className='hover:text-fourth-200 py-1'> <Link to={'/services'}> {t('footer.capacitacion')} </Link></p>
            </div>
