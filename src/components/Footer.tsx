...
const Footer = () => {
  ...
  return (
    <footer className='bg-fourth-400 text-white'>
        <div className='max-w-7xl px-10 py-6 mx-auto gap-16 grid grid-cols-4'>
            ...
            <div className='flex flex-col'>
                ...
                <p className='py-1'>{t('footer.about-us')}</p>
                <p className='py-1'>{t('footer.services')}</p>
            </div>

            <div className='flex flex-col'>
                <p className='py-1 text-2xl text-tertiary-400 font-bold text-footer-widgets'> {t('footer.services')} </p>
                <p className='py-1'>{t('footer.regulatory-affairs')}</p>
                {/* Por agregar 'Licencias y permisos'*/}
                <p className='py-1'> {t('footer.auditories')} </p>
                <p className='py-1'> {t('footer.capacitacion')} </p>
            </div>
        ...
        <div className='max-w-7xl mx-auto px-8 grid grid-cols-3 text-neutral-500 border-t border-t-[1px] border-t-neutral-500'>
            <p> {t('footer.rights')} </p>
